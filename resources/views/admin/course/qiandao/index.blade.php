...
<a href="/adminconsole/qiandao_daochu" class="btn btn-default btn-sm hidden" type="button">导出签到人员</a>
<a class="btn btn-success btn-sm hidden" href="/adminconsole/qiandao/" role="button">签到码</a>
<a class="btn btn-warning btn-sm hidden" href="/adminconsole/qiantui/" role="button">签退码</a>
@endsection
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped table-hover" id="j_list" >
            ...
            <tr>
                ...
                <td>
                    <a href="/adminconsole/course_qiandao2?classid={{$v->id}}&amp;courseid={{$oj->course->id . '&amp;classorder=' . ($loop->index+1) }}">
                        进入
                    </a>
                </td>
            </tr>         
