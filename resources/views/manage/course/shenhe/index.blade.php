...
?>
@section('operate')
<a href="{{$cc}}/allpass?courseid={{$courseid}}" rel="myform" class="btn btn-default btn-md j_batch " type="button">批量审核</a>
<a href="{{$cc}}/import?courseid={{$courseid}}" class="btn btn-default btn-md " type="button">导入报名</a>
<a href="{{$cc}}/export?courseid={{$courseid}}" class="btn btn-default btn-md " type="button">导出报名</a>
@endsection
            ...
            <table class="table table-striped table-hover" id="j_list" >
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{$currentcontroller}}/dopass/{{$v->id}}?courseid={{$courseid}}" class="j_confirmpost" title="审核通过">
                            通过
                        </a>&nbsp;
                        @endif

                        @if( 'unpass' != $v->auditstatus)
                        <a href="{{$currentcontroller}}/unpass/{{$v->id}}?courseid={{$courseid}}" class="j_open">
                            未通过
                        </a> 	
                        @endif
