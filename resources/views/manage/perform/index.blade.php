...
<div class="row page-title-row" >
    ...
    <div class="col-md-6 text-right" >
		{{--辅导员，团委，牵头部门可添加--}}
		@if(cancreatperform())
        <a href="{{ $cc }}/select_" class="btn btn-success btn-md" type="button">
            添加
        </a>		     
		@endif
    </div>	
    ...
    <table class="table table-striped table-hover" id="j_list" >
        ...
        <tr>
            ...
            <td class="tdoperate">
				...
				<a href="{{$cc}}/{{$v->id}}" class="j_del alarm" title="删除{{$v->realname}}" data-title1="姓名" data-title2="{{$v->title}}" data-title3="履职">
				 删除
				</a>
            </td>
        </tr>
