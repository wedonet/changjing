...
class xuefenController extends Controller {
    ...
    function __construct() {
        $this->currentcontroller = '/manage/xuefen'; //控制器
        $this->viewfolder = 'manage.xuefen'; //视图路径
        $this->dbname = 'xuefen';
    ...
    public function dayin($id)
    {
        return view($this->viewfolder . '.dayin', ['j' => $this->j]);
    }
    public function xuefendetail($id)
    {

        return view($this->viewfolder . '.xuefendetail', ['j' => $this->j]);
    }
}
