...
class xiaowaiqiantouController extends Controller {
    ...
    function __construct() {
        $this->currentcontroller = '/manage/xiaowaiqiantou'; //控制器
        $this->viewfolder = 'manage.xiaowaiqiantou'; //视图路径
        $this->dbname = 'huodong';

        $this->j['nav'] = 'xiaowaiqiantou';
