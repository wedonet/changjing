...
class xiaoneifudaoController extends Controller {
    ...
    function __construct() {
        $this->oj = (object) [];
        $this->currentcontroller = '/manage/xiaoneifudao'; //控制器
        $this->viewfolder = 'manage.xiaoneifudao.'; //视图路径
        $this->dbname = 'innerhonor';

        $this->oj->nav = 'xiaoneifudao';
    ...
    public function index() {
        $list = DB::table($this->dbname)
                ->orderby('id', 'desc')
                ->where('ucode', $_ENV['user']['mycode']) //我发的
    ...
    function student($id, Request $request) {
        ...
        $this->oj->innerhonor = $request->oj->innerhonor;
        $this->oj->list = $list;
