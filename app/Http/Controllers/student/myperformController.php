...
class myperformController extends Controller {
    ...
    function __construct(performRepository $cr) {
        ...
        $this->currentcontroller = '/student/myperform'; //控制器
        $this->viewfolder = 'student.perform'; //视图路径
        $this->dbname = 'perform';

        $this->oj->nav = 'myperform';
