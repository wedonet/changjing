...
class managechangepassController extends Controller {
    ...
    function __construct() {
        $this->currentcontroller = 'managechangepassController'; //控制器
    ...
    public function index(Request $request) {
        ...
        return view('managechangepass', ['j' => $this->j]);
    }
    ...
    public function dochange(Request $request) {
        ...
        DB::table('loginchangepass')
                ->insert($rs);

        $suctip[] = '修改成功，请重新登录';
        $suctip[] = '<a href="/managelogin">点击这里重新登录</a>';
