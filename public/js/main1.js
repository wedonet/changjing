...
function loading() {
    ...
    str += '<div align="center" style="width:31px;position:fixed;left:50%;top:50%;margin-left:-15px;" id="centertable"><img src="/images/ajax-loader.gif" /></div>';
...
function tabSwitch(obj){
    var elm=obj.getAttribute('data-i');
    $(obj).addClass('hover').parent().siblings('li').children('a').removeClass('hover');
    $(elm).css('display','block').siblings().css('display','none');
}
